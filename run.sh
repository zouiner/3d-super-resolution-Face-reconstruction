#!/bin/bash
#SBATCH --job-name=sr3d_8_32_val_15             # Job name
...
#SBATCH --output=cuda_log/cuda_job_sr3d_8_32_val_15_%j.log      # Standard output and error log
...
# python main_temp.py -p val -c config/sr_sr3_VGGF2_8_16_model2.yml -m model2 
