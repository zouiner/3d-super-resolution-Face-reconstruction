...
from datasets.creation.instances.lyhm_all import LYHM_all
...
if __name__ == '__main__':
    ...
    # datasets = [FaceWarehouse(), LYHM(), D3DFACS(), FRGC(), Florence(), Stirling(), BU3DFE(), PB4D(), LYHM_all()]
    # generator = Generator([FaceWarehouse()])
    datasets = [LYHM_all()]
    generator = Generator([LYHM_all()])

    generator.run()

# python /shared/storage/cs/staffstore/ps1510/Tutorial/3d-super-resolution-Face-reconstruction/datasets/creation/main.py