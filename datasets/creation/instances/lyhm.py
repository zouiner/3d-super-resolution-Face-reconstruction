...
class LYHM(Instance, ABC):
    def __init__(self):
        ...
        self.dst = '/shared/storage/cs/staffstore/ps1510/Tutorial/MICA/datasets/arcface/LYHM'
        self.src = '/shared/storage/cs/staffstore/ps1510/Tutorial/MICA/datasets/LYHM/'
