...
def build_train(config, is_train=True):
    ...
    if 'mocktest' in config.training_data:
        data_list.append(mockDataset(K=config.K, image_size=config.image_size, scale=[config.scale_min, config.scale_max], trans_scale=config.trans_scale))
    if 'mocktest_old' in config.training_data:
        data_list.append(mockDataset_old(K=config.K, image_size=config.image_size, scale=[config.scale_min, config.scale_max], trans_scale=config.trans_scale))
...
def build_val(config, is_train=True):
    ...
    if 'mocktest' in config.eval_data:
        data_list.append(mockDataset(K=config.K, image_size=config.image_size, scale=[config.scale_min, config.scale_max], trans_scale=config.trans_scale, isEval=True))
    if 'mocktest_old' in config.eval_data:
        data_list.append(mockDataset_old(K=config.K, image_size=config.image_size, scale=[config.scale_min, config.scale_max], trans_scale=config.trans_scale, isEval=True))
    dataset = ConcatDataset(data_list)
